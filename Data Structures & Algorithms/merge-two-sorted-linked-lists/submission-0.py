...
class Solution:
    def mergeTwoLists(self, list1: Optional[ListNode], list2: Optional[ListNode]) -> Optional[ListNode]:
        dummy = ListNode() #creates a list node
        tail = dummy #points tail to it (preventing error)
        ...
        return dummy.next #return all the elements stored into the dummy nodes as tail
        # was getting pointed to new elements matching the conditions
